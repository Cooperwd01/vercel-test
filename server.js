...
// Serve scot gov files
app.use('/scot-gov', express.static(path.join(__dirname, 'node_modules', '@scottish-government', 'design-system', 'dist', 'css')));

app.use('/js', express.static(path.join(__dirname, 'node_modules', '@scottish-government', 'design-system', 'dist', 'scripts')));

app.use('/images', express.static(path.join(__dirname, 'node_modules', '@scottish-government', 'design-system', 'dist', 'images')));
